...
*/
class BOTAN_DLL IF_Scheme_PublicKey
   {
   public:
      ...
      */
      ...
      X509_Encoder* x509_encoder(const OID&) const;
...
* of integer factorization based (IF) public key schemes.
*/
class BOTAN_DLL IF_Scheme_PrivateKey
   {
   public:
      bool check_key(RandomNumberGenerator& rng, bool) const;
