...
*************************************************/
void BigInt::grow_reg(length_type n) const
   {
...
* Grow the internal storage                      *
*************************************************/
void BigInt::grow_to(length_type n) const
   {
   if(n > size())
...
/*************************************************
* Convert this number to a length_type, if possible   *
*************************************************/
...
*************************************************/
length_type BigInt::sig_words() const
   {
   const word* x = data();
   length_type top_set = size();
...
*************************************************/
word& BigInt::operator[](length_type index)
   {
   reg.grow_to(index+1);
   return reg[index];
   }
...
*************************************************/
word BigInt::operator[](length_type index) const
   {
